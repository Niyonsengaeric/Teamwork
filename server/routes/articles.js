...
router.post('/articles/:id/flag', [authChecker.auth, validateFlag], flagArticle);
router.post('/comments/:id/flag', [authChecker.auth, validateFlag], flagComment);
router.get('/flags', [authChecker.auth, adminChecker.adminChecker], getFlags);

router.post('/articles/:id/comments', [authChecker.auth, validatecomment], commentArticle);
